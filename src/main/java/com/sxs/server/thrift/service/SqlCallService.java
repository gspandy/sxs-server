 ...
 *  @generated
 */
package com.sxs.server.thrift.service;
...
public class SqlCallService {
  ...
  public interface Iface {
    ...
    public OperationResult insertSql(SqlCallParameter sqlCallParameter) throws TException;

    public OperationResult selectSql(SqlCallParameter sqlCallParameter) throws TException;

    public OperationResult updateSql(SqlCallParameter sqlCallParameter) throws TException;

    public OperationResult deleteSql(SqlCallParameter sqlCallParameter) throws TException;

    public OperationResult batchOperationSql(List<SqlCallParameter> parameterList) throws TException;

  }

  public interface AsyncIface {

    public void insertSql(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler) throws TException;

    public void selectSql(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler) throws TException;

    public void updateSql(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler) throws TException;

    public void deleteSql(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler) throws TException;

    public void batchOperationSql(List<SqlCallParameter> parameterList, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_insertSql(SqlCallParameter sqlCallParameter) throws TException
    {
    ...
    public OperationResult recv_insertSql() throws TException
    {
    ...
    public void send_selectSql(SqlCallParameter sqlCallParameter) throws TException
    {
    ...
    public OperationResult recv_selectSql() throws TException
    {
    ...
    public void send_updateSql(SqlCallParameter sqlCallParameter) throws TException
    {
    ...
    public OperationResult recv_updateSql() throws TException
    {
    ...
    public void send_deleteSql(SqlCallParameter sqlCallParameter) throws TException
    {
    ...
    public OperationResult recv_deleteSql() throws TException
    {
    ...
    public void send_batchOperationSql(List<SqlCallParameter> parameterList) throws TException
    {
    ...
    public OperationResult recv_batchOperationSql() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class insertSql_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public insertSql_call(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class selectSql_call extends org.apache.thrift.async.TAsyncMethodCall {
      private SqlCallParameter sqlCallParameter;
      public selectSql_call(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sqlCallParameter = sqlCallParameter;
      }
    ...
    public static class updateSql_call extends org.apache.thrift.async.TAsyncMethodCall {
      private SqlCallParameter sqlCallParameter;
      public updateSql_call(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sqlCallParameter = sqlCallParameter;
      }
    ...
    public static class deleteSql_call extends org.apache.thrift.async.TAsyncMethodCall {
      private SqlCallParameter sqlCallParameter;
      public deleteSql_call(SqlCallParameter sqlCallParameter, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sqlCallParameter = sqlCallParameter;
      }
    ...
    public static class batchOperationSql_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public batchOperationSql_call(List<SqlCallParameter> parameterList, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class insertSql<I extends Iface> extends org.apache.thrift.ProcessFunction<I, insertSql_args> {
      ...
      public insertSql_result getResult(I iface, insertSql_args args) throws TException {
        insertSql_result result = new insertSql_result();
    ...
    public static class selectSql<I extends Iface> extends org.apache.thrift.ProcessFunction<I, selectSql_args> {
      ...
      public selectSql_result getResult(I iface, selectSql_args args) throws TException {
        selectSql_result result = new selectSql_result();
    ...
    public static class updateSql<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateSql_args> {
      ...
      public updateSql_result getResult(I iface, updateSql_args args) throws TException {
        updateSql_result result = new updateSql_result();
    ...
    public static class deleteSql<I extends Iface> extends org.apache.thrift.ProcessFunction<I, deleteSql_args> {
      ...
      public deleteSql_result getResult(I iface, deleteSql_args args) throws TException {
        deleteSql_result result = new deleteSql_result();
    ...
    public static class batchOperationSql<I extends Iface> extends org.apache.thrift.ProcessFunction<I, batchOperationSql_args> {
      ...
      public batchOperationSql_result getResult(I iface, batchOperationSql_args args) throws TException {
        batchOperationSql_result result = new batchOperationSql_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class insertSql<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, insertSql_args, OperationResult> {
      ...
      public void start(I iface, insertSql_args args, AsyncMethodCallback<OperationResult> resultHandler) throws TException {
    ...
    public static class selectSql<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, selectSql_args, OperationResult> {
      ...
      public void start(I iface, selectSql_args args, AsyncMethodCallback<OperationResult> resultHandler) throws TException {
    ...
    public static class updateSql<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateSql_args, OperationResult> {
      ...
      public void start(I iface, updateSql_args args, AsyncMethodCallback<OperationResult> resultHandler) throws TException {
    ...
    public static class deleteSql<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deleteSql_args, OperationResult> {
      ...
      public void start(I iface, deleteSql_args args, AsyncMethodCallback<OperationResult> resultHandler) throws TException {
    ...
    public static class batchOperationSql<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, batchOperationSql_args, OperationResult> {
      ...
      public void start(I iface, batchOperationSql_args args, AsyncMethodCallback<OperationResult> resultHandler) throws TException {
  ...
  public static class insertSql_args implements org.apache.thrift.TBase<insertSql_args, insertSql_args._Fields>, java.io.Serializable, Cloneable, Comparable<insertSql_args>   {
    ...
    private static class insertSql_argsStandardScheme extends StandardScheme<insertSql_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, insertSql_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, insertSql_args struct) throws TException {
        struct.validate();
    ...
    private static class insertSql_argsTupleScheme extends TupleScheme<insertSql_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, insertSql_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, insertSql_args struct) throws TException {
  ...
  public static class insertSql_result implements org.apache.thrift.TBase<insertSql_result, insertSql_result._Fields>, java.io.Serializable, Cloneable, Comparable<insertSql_result>   {
    ...
    private static class insertSql_resultStandardScheme extends StandardScheme<insertSql_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, insertSql_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, insertSql_result struct) throws TException {
        struct.validate();
    ...
    private static class insertSql_resultTupleScheme extends TupleScheme<insertSql_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, insertSql_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, insertSql_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OperationResult();
  ...
  public static class selectSql_args implements org.apache.thrift.TBase<selectSql_args, selectSql_args._Fields>, java.io.Serializable, Cloneable, Comparable<selectSql_args>   {
    ...
    private static class selectSql_argsStandardScheme extends StandardScheme<selectSql_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, selectSql_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, selectSql_args struct) throws TException {
        struct.validate();
    ...
    private static class selectSql_argsTupleScheme extends TupleScheme<selectSql_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, selectSql_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSqlCallParameter()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, selectSql_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.sqlCallParameter = new SqlCallParameter();
  ...
  public static class selectSql_result implements org.apache.thrift.TBase<selectSql_result, selectSql_result._Fields>, java.io.Serializable, Cloneable, Comparable<selectSql_result>   {
    ...
    private static class selectSql_resultStandardScheme extends StandardScheme<selectSql_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, selectSql_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, selectSql_result struct) throws TException {
        struct.validate();
    ...
    private static class selectSql_resultTupleScheme extends TupleScheme<selectSql_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, selectSql_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, selectSql_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OperationResult();
  ...
  public static class updateSql_args implements org.apache.thrift.TBase<updateSql_args, updateSql_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateSql_args>   {
    ...
    private static class updateSql_argsStandardScheme extends StandardScheme<updateSql_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, updateSql_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateSql_args struct) throws TException {
        struct.validate();
    ...
    private static class updateSql_argsTupleScheme extends TupleScheme<updateSql_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateSql_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSqlCallParameter()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateSql_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.sqlCallParameter = new SqlCallParameter();
  ...
  public static class updateSql_result implements org.apache.thrift.TBase<updateSql_result, updateSql_result._Fields>, java.io.Serializable, Cloneable, Comparable<updateSql_result>   {
    ...
    private static class updateSql_resultStandardScheme extends StandardScheme<updateSql_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, updateSql_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateSql_result struct) throws TException {
        struct.validate();
    ...
    private static class updateSql_resultTupleScheme extends TupleScheme<updateSql_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateSql_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateSql_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OperationResult();
  ...
  public static class deleteSql_args implements org.apache.thrift.TBase<deleteSql_args, deleteSql_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteSql_args>   {
    ...
    private static class deleteSql_argsStandardScheme extends StandardScheme<deleteSql_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, deleteSql_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, deleteSql_args struct) throws TException {
        struct.validate();
    ...
    private static class deleteSql_argsTupleScheme extends TupleScheme<deleteSql_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, deleteSql_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSqlCallParameter()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, deleteSql_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.sqlCallParameter = new SqlCallParameter();
  ...
  public static class deleteSql_result implements org.apache.thrift.TBase<deleteSql_result, deleteSql_result._Fields>, java.io.Serializable, Cloneable, Comparable<deleteSql_result>   {
    ...
    private static class deleteSql_resultStandardScheme extends StandardScheme<deleteSql_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, deleteSql_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, deleteSql_result struct) throws TException {
        struct.validate();
    ...
    private static class deleteSql_resultTupleScheme extends TupleScheme<deleteSql_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, deleteSql_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, deleteSql_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OperationResult();
  ...
  public static class batchOperationSql_args implements org.apache.thrift.TBase<batchOperationSql_args, batchOperationSql_args._Fields>, java.io.Serializable, Cloneable, Comparable<batchOperationSql_args>   {
    ...
    private static class batchOperationSql_argsStandardScheme extends StandardScheme<batchOperationSql_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, batchOperationSql_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, batchOperationSql_args struct) throws TException {
        struct.validate();
    ...
    private static class batchOperationSql_argsTupleScheme extends TupleScheme<batchOperationSql_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, batchOperationSql_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, batchOperationSql_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
  ...
  public static class batchOperationSql_result implements org.apache.thrift.TBase<batchOperationSql_result, batchOperationSql_result._Fields>, java.io.Serializable, Cloneable, Comparable<batchOperationSql_result>   {
    ...
    private static class batchOperationSql_resultStandardScheme extends StandardScheme<batchOperationSql_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, batchOperationSql_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, batchOperationSql_result struct) throws TException {
        struct.validate();
    ...
    private static class batchOperationSql_resultTupleScheme extends TupleScheme<batchOperationSql_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, batchOperationSql_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, batchOperationSql_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OperationResult();
